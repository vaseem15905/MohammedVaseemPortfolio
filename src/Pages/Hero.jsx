...
function Hero() {
  return (
    <div className="h-screen flex flex-col items-start justify-between bg-[#031306] relative pt-32 px-6 sm:px-12 lg:px-20 pb-10 sm:pb-0">
      <CursorEffect />

      {/* Background Effects */}
      <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full bg-[rgb(0,255,47)] blur-[400px]"></div>
      <div className="absolute top-0 left-0 w-96 h-96 -translate-x-44 rounded-full bg-[rgb(0,255,47)] blur-[400px]"></div>

      {/* Hero Content */}
      <div className="z-10 mt-6 sm:mt-16">
        <h1 className="text-white font-lexend font-extralight text-4xl sm:text-5xl">Hi, I'm</h1>
        ...
        <p className="text-white font-sans font-thin text-base sm:text-2xl mt-4">
        ...
        <div className="flex gap-4 sm:gap-6 mt-8">
          <button className="p-2 sm:p-3 px-4 sm:px-6 text-[#00ff2f] border border-[#00ff2f] rounded-md shadow-[0_0_2px_rgb(0,255,47)] hover:shadow-[0_0_20px_rgb(0,255,47)] hover:scale-110 hover:bg-[#00ff2f] hover:text-black transition-all">
            Hire Me!
          </button>
          <button className="p-2 sm:p-3 px-4 sm:px-6 text-[#00ff2f] border border-[#00ff2f] rounded-md shadow-[0_0_2px_rgb(0,255,47)] hover:shadow-[0_0_20px_rgb(0,255,47)] hover:scale-110 hover:bg-[#00ff2f] hover:text-black transition-all">
            Download Resume
